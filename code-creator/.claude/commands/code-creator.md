...
Read and follow [`../SKILL.md`](../SKILL.md) in full. `$ARGUMENTS` is the ticket ID (e.g. `CNGBA-123`).

Legacy inline steps below are kept for reference only — the SKILL.md is authoritative.
